...
public class GameStatisticsDto {
    ...
    public GameStatisticsDto(Long id, Integer totalPoints, Integer durationMinutes, Integer totalThreePointShots,
            Integer totalSetShots, Integer totalFreeShots, Integer totalRebounds, Integer totalBlockedShot,
            Integer totalAssists, Integer totalPersonalFouls, Integer totalTechnicalFouls,
            ...
            Integer totalTechnicalFoulsRival, Integer totalUnsportsmanlikeFoulsRival) {
        this.id = id;
