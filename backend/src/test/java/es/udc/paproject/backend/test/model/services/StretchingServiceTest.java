...
public class StretchingServiceTest {
    ...
    public void testAddStretchingAndFindStretchingById() throws InstanceNotFoundException {
        ...
        Stretching stretching = stretchingService.addStretching("stretchingName", "description", "Isquiotibiales");
    ...
    public void testFindAllStretchings() throws InstanceNotFoundException, DuplicateInstanceException,
        ...
        stretchingService.addStretching("stretchingName", "description", "Isquiotibiales");
        stretchingService.addStretching("stretchingName2", "descript2ion", "Pectoral");
        stretchingService.addStretching("stretchingName2", "descript2ion", "Adductores");
        stretchingService.addStretching("stretchingName2", "descript2ion", "Ingle");
        stretchingService.addStretching("stretchingName2", "descript2ion", "Ingle");
    ...
    public void testFindStretchingsByType() throws InstanceNotFoundException, DuplicateInstanceException,
        ...
        List<Stretching> stretchings1 = stretchingService.findStretchingsByType("Ingle");
        List<Stretching> stretchings2 = stretchingService.findStretchingsByType("Adductores");
        List<Stretching> stretchings3 = stretchingService.findStretchingsByType("Isquiotibiales");
    ...
    public void testRemoveStretching() throws InstanceNotFoundException, DuplicateInstanceException,
        ...
        stretchingService.addStretching("stretchingName", "description", "Isquiotibiales");
        stretchingService.addStretching("stretchingName2", "descript2ion", "Pectoral");
        Stretching stretching = stretchingService.addStretching("stretchingName2", "descript2ion", "Adductores");
        stretchingService.addStretching("stretchingName2", "descript2ion", "Ingle");
        stretchingService.addStretching("stretchingName2", "descript2ion", "Ingle");
    ...
    public void testUpdatStretching() throws InstanceNotFoundException,
        ...
        Stretching stretchingUpdated = stretchingService.updatStretching(stretching2.getId(), "cambio", "je je je", "Cuadriceps");
        ...
        assertEquals(stretchingFound.getStretchingType(), "Cuadriceps");
