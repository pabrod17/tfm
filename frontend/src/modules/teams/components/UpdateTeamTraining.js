...
import TrainingsByTeam from '../../trainings/components/TrainingsByTeam';


const UpdateTeamTraining = () => {
    ...
    const trainingsList = useSelector(selectorsTrainings.getTrainingsByTeamId);

    useEffect(() => {
        if (!trainingsList) {
            dispatch(actionsTrainings.findTrainingsByTeamId(id, () => history(`/teams/update/${id}/training/${4}`)));
            dispatch(actions.findTeamById(id, () => history(`/teams/update/${id}/training/${4}`)));
        }
    ...
    return (
        ...
        >
            ...
            >
                ...
                <TrainingsByTeam trainings={trainingsList} teamId={id} />
...
export default UpdateTeamTraining;