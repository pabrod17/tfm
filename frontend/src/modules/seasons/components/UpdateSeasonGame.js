...
const UpdateSeasonGame = () => {
    ...
    useEffect(() => {
        if (!gamesList) {
            dispatch(actionsGames.findGamesBySeasonId(id, () => history(`/seasons/update/${id}/game/${3}`)));
    ...
    return (
        ...
        >
            ...
            >
                ...
                <GamesBySeason games={gamesList} seasonId={id} />
...
export default UpdateSeasonGame;