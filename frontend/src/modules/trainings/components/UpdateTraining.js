...
const UpdateTraining = () => {
    ...
    const handleSubmit = event => {
        ...
        const handleUpdateTrainingExercises = (dispatch) => {
            dispatch(actions.findTrainingById(id, () => history(`/trainings/update/${id}/trainings`)));
        }
        const handleUpdateTrainingStretchings = (dispatch) => {
            dispatch(actions.findTrainingById(id, () => history(`/trainings/update/${id}/stretchings`)));
        }
...
<Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        ...
        >
          ...
          <Tab sx={{ color: '#f5af19', fontSize: "30px", padding:"20px" }} onClick={() => handleUpdateTrainingExercises(dispatch)} label="Exercises"  />
          <Tab sx={{ color: 'rgb(255, 0, 247)', fontSize: "30px", padding:"20px" }} onClick={() => handleUpdateTrainingStretchings(dispatch)} label="Stretchings"  />
        </Tabs>
      </Box>
</Box>
